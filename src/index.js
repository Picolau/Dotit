...
var STORAGE_KEY = 'Joido Storage Key';
var secureStorage = new SecureStorage(localStorage, {
  hash: function hash(key) {
    key = CryptoJS.SHA256(key, STORAGE_KEY);

    return key.toString();
  },
  encrypt: function encrypt(data) {
    data = CryptoJS.AES.encrypt(data, STORAGE_KEY);
  ...
  decrypt: function decrypt(data) {
    data = CryptoJS.AES.decrypt(data, STORAGE_KEY);
